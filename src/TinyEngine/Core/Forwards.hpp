...
namespace TinyEngine
{
	...
	TINY_ENGINE_FORWARD_CLASS(IMetaInfo)
	TINY_ENGINE_FORWARD_CLASS(Factory)
	TINY_ENGINE_FORWARD_CLASS(ISerializable)
	...
	TINY_ENGINE_FORWARD_CLASS(PropertyData)
	TINY_ENGINE_FORWARD_CLASS(IProperty)
	TINY_ENGINE_FORWARD_CLASS(IntPropertyWrapper)
	TINY_ENGINE_FORWARD_CLASS(IntProperty)
	TINY_ENGINE_FORWARD_CLASS(Properties)
}
