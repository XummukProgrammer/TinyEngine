...
namespace TinyEngine
{
	...
	TINY_ENGINE_FORWARD_ENUM_CLASS(CompareConditionOperation)
	TINY_ENGINE_FORWARD_ENUM_CLASS(FileBrowserState)
	...
	TINY_ENGINE_FORWARD_CLASS(Resource)
	...
	TINY_ENGINE_FORWARD_CLASS(GuiFileBrowserWidget)
	...
	TINY_ENGINE_FORWARD_CLASS(TextureResource)
	...
	TINY_ENGINE_FORWARD_CLASS(SceneNode)
